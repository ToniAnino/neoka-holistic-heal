    ...
    <main className="min-h-screen">
      ...
      <section className="relative h-[400px] md:h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-foreground max-w-2xl mx-auto animate-fade-up animation-delay-100 mb-4 font-medium bg-background/50 backdrop-blur-sm rounded-xl px-6 py-3">
            Un camino de autoconocimiento, sentido y transformación interior
          </p>
          <h2 className="text-xl md:text-2xl text-foreground font-medium max-w-2xl mx-auto animate-fade-up animation-delay-100 mb-8 bg-background/50 backdrop-blur-sm rounded-xl px-6 py-3">
